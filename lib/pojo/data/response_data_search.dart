...
//
//     final responseDataSearch = responseDataSearchFromJson(jsonString);

import 'dart:convert';

ResponseDataSearch responseDataSearchFromJson(String str) => ResponseDataSearch.fromJson(json.decode(str));

String responseDataSearchToJson(ResponseDataSearch data) => json.encode(data.toJson());

class ResponseDataSearch {
  ResponseDataSearch({
    this.data,
    this.links,
    this.meta,
  ...
  ResponseDataSearchLinks links;
  Meta meta;

  factory ResponseDataSearch.fromJson(Map<String, dynamic> json) => ResponseDataSearch(
    data: List<DataSearch>.from(json["data"].map((x) => DataSearch.fromJson(x))),
    links: ResponseDataSearchLinks.fromJson(json["links"]),
...
class DataSearch {
  ...
  factory DataSearch.fromJson(Map<String, dynamic> json) => DataSearch(
    ...
    images: List<ImageSearch>.from(json["images"].map((x) => ImageSearch.fromJson(x))),
  );
...
class ResponseDataSearchLinks {
  ResponseDataSearchLinks({
    this.first,
    this.last,
    this.prev,
    this.next,
  ...
  factory ResponseDataSearchLinks.fromJson(Map<String, dynamic> json) => ResponseDataSearchLinks(
    first: json["first"],
    last: json["last"],
    prev: json["prev"],
    next: json["next"],
