...
//   List<Widget> _buildList(DataCategory productData) {
//     var list = new List<Widget>();
//
//     for (int i = 0; i < productData.arr.length; i++) {
//       print(productData.arr[i]);
//       list.add(ListView(
//         children: [
//           InkWell(
//               onTap: () {
...
//                                 width: 60,
//                                 height: 60,
//                                 child: productData.arr[i].images[0].url == null
//                                     ? Container()
//                                     : CachedNetworkImage(
//                                         imageUrl:
//                                             productData.arr[i].images[0].url,
...
//                                       width: 120,
//                                       child: Text(
//                                         productData.arr[i].name != null
//                                             ? productData.arr[i].name
//                                             : "",
//                                         style: TextStyle(
//                                             color: KColorecart,
...
//                                       width: 150,
//                                       child: Text(
//                                           productData.arr[i].description != null
//                                               ? productData.arr[i].description
//                                               : "",
//                                           style: TextStyle(
//                                               color: KColoredesc,
...
//                                     child: Text(
//                                       productData.arr[i].oldPrice.formatted,
//                                       style: TextStyle(
//                                           color: KColorecart,
...
// //     children: [
// //       ListView.builder(
// //         itemCount: productData.arr.length,
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                            () {
                                                                          print( Provider.of<HomeProviders>(context, listen: false).categories[index].arr[index2].name.toString());
                                                                          CartModel cartmodel = new CartModel(
                                                                              Provider.of<HomeProviders>(context, listen: false).categories[index].arr[index2].id.toString(),
                                                                              "1",
                                                                              Provider.of<HomeProviders>(context, listen: false).categories[index].arr[index2].oldPrice.price.toString(),
