...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  String getSizeData(int indexone, BuildContext context) {
    int size = Provider
        .of<HomeProviders>(context, listen: true)
        .categories[indexone]
        .arr
        .length;
  ...
  final ShardPreferencesEditor shardPreferencesEditor = ShardPreferencesEditor();
  ...
  showAlertDialog(BuildContext context) {
      ...
      child: Container(
        width: double.infinity,
          ...
          child: Padding(
            ...
            child: Center(child: Text("تسجيل الدخول",style: TextStyle(color: Colors.white,fontSize: 14))),
          )),
      onPressed: () {
    ...
    AlertDialog alert = AlertDialog(
      title: Row(
        ...
        children: [
          Text("من فضلك سجل الدخول ",style:TextStyle(color: KColorecart,fontSize: 15,fontWeight: FontWeight.bold)),
        ],
      ),
